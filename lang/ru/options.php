...
$MESS[$suffix.".SERVICE_MSG"] = "<div class='wbs24_wbapi_service_msg'><img src='/bitrix/images/wbs24.wbapi/logo.png' alt='Логотип WEB Симфония' style='padding: 0 10px 0 0;'><span>Техподдержка компании <a href='https://wbs24.ru/' target='_blank'>«WEB Симфония»</a> готова бесплатно оказать помощь в настройке модуля.<br>Нужна помощь? Напишите нам на почту <a href='mailto:mail@wbs24.ru' target='_blank'>mail@wbs24.ru</a></span></div>";
